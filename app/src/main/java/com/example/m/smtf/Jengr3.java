...
public class Jengr3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_jengr3, container, false);
        ...
        call.enqueue(new Callback<List<FilmDetail>>() {
            ...
            public void onResponse(Call<List<FilmDetail>> call, Response<List<FilmDetail>> response) {
                ...
                List<FilmDetail> ac = new ArrayList<>();

                for(int i=0; i<fd.size(); i++){
                    if(fd.get(i).repGenreNm.equals("액션")){
                        ac.add(fd.get(i));
                    }
                }
                ...
                adapter = new RecyclerviewAdapter(getActivity(), ac);
